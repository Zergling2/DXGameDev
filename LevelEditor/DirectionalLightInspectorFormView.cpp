...
void CDirectionalLightInspectorFormView::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EDIT_DIRECTIONAL_LIGHT_DIFFUSE_R, m_editDiffuseR);
	DDX_Control(pDX, IDC_EDIT_DIRECTIONAL_LIGHT_DIFFUSE_G, m_editDiffuseG);
	DDX_Control(pDX, IDC_EDIT_DIRECTIONAL_LIGHT_DIFFUSE_B, m_editDiffuseB);
	DDX_Control(pDX, IDC_EDIT_DIRECTIONAL_LIGHT_DIFFUSE_A, m_editDiffuseA);
	DDX_Control(pDX, IDC_EDIT_DIRECTIONAL_LIGHT_SPECULAR_R, m_editSpecularR);
	DDX_Control(pDX, IDC_EDIT_DIRECTIONAL_LIGHT_SPECULAR_G, m_editSpecularG);
	DDX_Control(pDX, IDC_EDIT_DIRECTIONAL_LIGHT_SPECULAR_B, m_editSpecularB);
	DDX_Control(pDX, IDC_EDIT_DIRECTIONAL_LIGHT_SPECULAR_EXPONENT, m_editSpecularExp);
}

BEGIN_MESSAGE_MAP(CDirectionalLightInspectorFormView, CFormView)
	ON_EN_CHANGE(IDC_EDIT_DIRECTIONAL_LIGHT_DIFFUSE_R, &CDirectionalLightInspectorFormView::OnEnChangeEditDiffuseR)
	ON_EN_CHANGE(IDC_EDIT_DIRECTIONAL_LIGHT_DIFFUSE_G, &CDirectionalLightInspectorFormView::OnEnChangeEditDiffuseG)
	ON_EN_CHANGE(IDC_EDIT_DIRECTIONAL_LIGHT_DIFFUSE_B, &CDirectionalLightInspectorFormView::OnEnChangeEditDiffuseB)
	ON_EN_CHANGE(IDC_EDIT_DIRECTIONAL_LIGHT_DIFFUSE_A, &CDirectionalLightInspectorFormView::OnEnChangeEditDiffuseA)
	ON_EN_CHANGE(IDC_EDIT_DIRECTIONAL_LIGHT_SPECULAR_R, &CDirectionalLightInspectorFormView::OnEnChangeEditSpecularR)
	ON_EN_CHANGE(IDC_EDIT_DIRECTIONAL_LIGHT_SPECULAR_G, &CDirectionalLightInspectorFormView::OnEnChangeEditSpecularG)
	ON_EN_CHANGE(IDC_EDIT_DIRECTIONAL_LIGHT_SPECULAR_B, &CDirectionalLightInspectorFormView::OnEnChangeEditSpecularB)
	ON_EN_CHANGE(IDC_EDIT_DIRECTIONAL_LIGHT_SPECULAR_EXPONENT, &CDirectionalLightInspectorFormView::OnEnChangeEditSpecularExponent)
END_MESSAGE_MAP()
