...
constexpr float ANIMATION_DEAD_FRAME_TIME = 0.032f;
...
void GameResources::Awake()
{
	...
	m16a1_wd->m_pvAnims.insert(std::make_pair(WeaponAction::Idle, m16a1_animNames[WeaponAction::Idle]));
	m16a1_wd->m_tvAnims.insert(std::make_pair(WeaponAction::Draw, "draw_rifle"));
	...
	m4a1_wd->m_pvAnims.insert(std::make_pair(WeaponAction::Idle, m16a1_animNames[WeaponAction::Idle]));
	m4a1_wd->m_tvAnims.insert(std::make_pair(WeaponAction::Draw, "draw_rifle"));
	...
	usp_wd->m_pvAnims.insert(std::make_pair(WeaponAction::Idle, usp_animNames[WeaponAction::Idle]));
	usp_wd->m_tvAnims.insert(std::make_pair(WeaponAction::Draw, "draw_pistol"));
	...
	b92fsb_wd->m_pvAnims.insert(std::make_pair(WeaponAction::Idle, usp_animNames[WeaponAction::Idle]));
	b92fsb_wd->m_tvAnims.insert(std::make_pair(WeaponAction::Draw, "draw_pistol"));
