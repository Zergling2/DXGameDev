...
public:
	...
	bool PktProcCSReqHostGameStart(std::shared_ptr<GameSession> spSession);
	bool PktProcCSReqChangeReadyState(winppy::Packet packet, std::shared_ptr<GameSession> spSession);
private:
