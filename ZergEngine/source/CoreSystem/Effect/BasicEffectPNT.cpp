...
void XM_CALLCONV BasicEffectPNT::SetWorldMatrix(XMMATRIX w) noexcept
{
...
void XM_CALLCONV BasicEffectPNT::SetAmbientColor(XMVECTOR ambient) noexcept
{
...
void XM_CALLCONV BasicEffectPNT::SetDiffuseColor(XMVECTOR diffuse) noexcept
{
...
void XM_CALLCONV BasicEffectPNT::SetSpecularColor(XMVECTOR specular) noexcept
{
...
void XM_CALLCONV BasicEffectPNT::SetReflection(XMVECTOR reflect) noexcept
{
...
void BasicEffectPNT::KickedFromDeviceContext() noexcept
{
	ClearTextureSRVArray();
