...
PSOutput main(PSInputPNTTFragment input)
{
    ...
    if (IsUsingMaterial(cb_perSubset.mtl.mtlFlag))
    {
        ...
        {
            ComputeDirectionalLight(cb_perFrame.dl[i], cb_perSubset.mtl, normalW, toEyeW, oA, oD, oS);
            ambient += oA;
            diffuse += oD;
            specular += oS;
        }
        ...
        {
            ComputePointLight(cb_perFrame.pl[i], cb_perSubset.mtl, input.posW, normalW, toEyeW, oA, oD, oS);
            ambient += oA;
            diffuse += oD;
            specular += oS;
        }
        ...
        {
            ComputeSpotLight(cb_perFrame.sl[i], cb_perSubset.mtl, input.posW, normalW, toEyeW, oA, oD, oS);
            ambient += oA;
            diffuse += oD;
            specular += oS;
        }
