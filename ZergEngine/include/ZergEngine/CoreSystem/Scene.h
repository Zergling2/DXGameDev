...
namespace ze
{
	...
	protected:
		// OnLoadScene() 함수에서는 반드시 Runtime::CreateGameObject() 함수 대신 이 함수로 게임 오브젝트를 생성해야 합니다.
	...
	private:
		// OnLoadScene에서는 반드시 Runtime::CreateGameObject() 함수 대신 IScene::CreateGameObject() 함수를 사용하여 게임 오브젝트를 생성해야 합니다.
